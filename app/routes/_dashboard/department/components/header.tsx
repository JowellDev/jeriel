...
export function Header({
	...
	return (
		<div className="pt-12 pb-4 pl-4 pr-4 sm:p-4 flex flex-row justify-between items-center mb-4 bg-card shadow">
			<div className="text-sm flex items-center sm:justify-center sm:items-center space-x-2 sm:space-x-4 divide-x-2 divide-border">
				<Button
