...
export function PieChartCard({ title }: Readonly<Props>) {
	return (
		<Card className="w-full shadow-none border-none">
			...
			<CardContent>
				<div className="grid sm:grid-cols-6 md:grid-cols-5 lg:grid-cols-5">
					<div className="sm:col-span-3 lg:col-span-3">
						<ChartContainer
							config={chartConfig}
							className="mx-auto aspect-square lg:max-h-[300px] md:max-h-[300px] sm:max-h-[200px]"
						>
							<PieChart>
								<ChartTooltip
									cursor={false}
					...
					<div className="sm:col-span-3 md:col-span-2 lg:col-span-2 flex justify-between">
						<div className="flex flex-col items-center justify-center">
							...
							<div className="text-2xl font-bold rounded-md p-2 bg-[#3BC9BF] w-fit text-white">
								11
							</div>
						</div>
						...
						<div className="flex flex-col items-center justify-center">
							...
							<div className="text-2xl font-bold rounded-md p-2 bg-[#F68D2B] w-fit text-white">
								300
							</div>
						</div>
					</div>
